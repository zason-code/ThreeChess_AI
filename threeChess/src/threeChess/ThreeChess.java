...
public class ThreeChess{
  ...
  public static void  tournament(Agent[] bots, int timeLimit, int numGames, Boolean displayOn, String logFile){
    ...
    if(numGames>=1){
        for(int g = 0; g<numGames; g++){//all combinations of three agents play each other. In each game the order is random.
  ...
  public static void main(String[] args){
    Agent[] bots = {new Agent22360143(), new MctsAgent(), new ParanoidAgent()};
    ...
    else //EDIT HERE, the 3rd argument.
        //for(int i=0;i<10;i++){
        tournament(bots,600,100,true,null);
    //}
    //}
  }
}
